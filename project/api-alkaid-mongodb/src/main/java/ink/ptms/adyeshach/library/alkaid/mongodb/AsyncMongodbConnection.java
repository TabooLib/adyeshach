...
import ink.ptms.adyeshach.library.alkaid.mongodb.interfaces.AsyncQueryActions;
...
public class AsyncMongodbConnection implements WriteableActions, AsyncQueryActions {
    ...
    public AsyncMongodbConnection(Gson gson, MongoDatabase database, ExecutorService pool) {
        this.gson = gson;
