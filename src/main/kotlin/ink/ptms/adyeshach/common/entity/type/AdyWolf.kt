...
class AdyWolf : AdyEntityTameable(EntityTypes.WOLF) {
    ...
    init {
        registerMeta(at(11700 to 19, 11400 to 18, 11000 to 16, 10900 to 15), "isBegging", false)
        registerMeta(at(11700 to 20, 11400 to 19, 11000 to 17, 10900 to 16), "collarColor", DyeColor.RED.ordinal)
