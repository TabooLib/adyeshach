...
class AdyMushroom : AdyCow(EntityTypes.MUSHROOM) {
    ...
    init {
        ...
        15
         */
        registerMeta(at(11500 to 16, 11400 to 15), "type", BukkitMushroom.RED.name.lowercase(Locale.getDefault()))
    ...
    fun setType(value: BukkitMushroom) {
        setMetadata("type", value.name.lowercase(Locale.getDefault()))
    }

    fun getType(): BukkitMushroom {
        return BukkitMushroom.valueOf(getMetadata<String>("type").uppercase(Locale.getDefault()))
    }
}